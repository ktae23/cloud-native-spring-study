...
class BookController(
    ...
    fun post(@Valid @RequestBody book: Book): Book = bookService.addBookToCatalog(book = book)
    ...
    @PutMapping("{isbn}")
    fun put(@Valid @PathVariable isbn: String, @RequestBody book: Book): Book = bookService.editBookDetails(isbn = isbn, book = book)
