...
class BookValidationTests {
    ...
    fun `when all fields correct then validation succeeds`() {
        val book = Book.of(isbn = "1234567890", title = "Title", author = "Author", publisher = "tester", price = 9.90)
    ...
    fun `when all fields incorrect then validation fails`() {
        val book = Book.of(isbn = "a1234567890", title = "Title", author = "Author", publisher = "tester", price = 9.90)
        val violations = validator.validate(book)
